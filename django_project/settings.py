...
SECRET_KEY = 'django-insecure-&2f_nq7n^l%d9v$y-26et3&pbzgl9oxx=2+5mcmar5ks3q_)y7'
...
DATABASES = {
    'default': {
        ...
        'NAME': '/app/data/db.sqlite3' if os.path.exists('/app/data') else BASE_DIR / 'db.sqlite3',
    }
}
